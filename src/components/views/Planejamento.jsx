    ...
    body: (
      <>
        ...
        <dl className="fact-grid">
          ...
          <dt>Mulheres impactadas</dt><dd>150 mulheres — 45 altamente engajadas, 100+ pessoas de influência direta</dd>
    ...
    body: (
      <>
        ...
        <ul>
          ...
          <li>São Francisco do Sul não elegeu nenhum vereador do Novo em 2024 — Cris Milli não herda estrutura partidária local, mas também não disputa capital político interno: pode se posicionar como a primeira liderança relevante da legenda na cidade.</li>
        </ul>
